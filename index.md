...
<div class="project-card" style="padding:1.0rem 1.0rem .9rem;">
  ...
  <p style="margin-top:.45rem;">
    Mechanical & Computer Engineering student building <b>numerical algorithms</b> for <b>nonlinear dynamics</b> and <b>real-time simulation</b>
    in <b>robotics</b> and <b>autonomous systems</b>.
  </p>

  <p style="opacity:.86; margin-top:.25rem;">
    Interests: <b>Optimal Control</b> · <b>Numerical Optimization</b> · <b>Dynamics</b>
  </p>
</div>
